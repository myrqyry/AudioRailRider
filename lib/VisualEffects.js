...
export class VisualEffects {
    ...
    update(elapsedTime, audioFeatures, cameraPosition) {
    ...
    spawnParticles(elapsedTime, cameraPosition) {
        ...
        for (let i = 0; i < spawnCount; i++) {
            ...
            velocities.setXYZ(pIndex, (Math.random() - 0.5) * 20, (Math.random() - 0.5) * 20, (Math.random() - 0.5) * 20);
