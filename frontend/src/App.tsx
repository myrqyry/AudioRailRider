        ...
        <main className="relative w-full h-screen bg-black overflow-hidden flex items-center justify-center">
            ...
            {ContentComponent && (
                <div className="relative z-20 p-4">
                    <RendererWarning />
                    <ContentComponent />
                    {/* Breathing Intensity Slider - show only when idle/error/finished (hide during Ready/Riding) */}
                    {(status === AppStatus.Idle || status === AppStatus.Error || status === AppStatus.Finished) && (
